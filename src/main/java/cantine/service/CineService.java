...
public class CineService {
    ...
    public String getCineDay(String login, String mdp) throws IOException, InterruptedException {
        String result = "";
        ...
        try (final WebClient webClient = new WebClient(BrowserVersion.FIREFOX_38, "proxy1.cer31.recouv", 8000)) {
            ...
            credentialsProvider.addCredentials(login, mdp);
            ...
            if (pageCineDays != null) {
                result = pageCineDays.asText().substring(pageCineDays.asText().indexOf("compte Internet+Mobile") + "compte Internet+Mobile".length(),
                ...
                sendSms.click();
                Thread.sleep(2000); //refresh de la page apres l'envoie par sms
